...
*** Game design
    ...
    Metroidvania design analysis: what makes a Metroidvania?
    Design analyses of character movement, camera, etc. in other platform games
    
    How to get a game project started: from 0 to a nice demo, /focus on the game creation workflow/
    How to get started with game creation, /game design and programming/
    How it's like to work as a game designer: a day in the life of an indie game designer
    Teaching the player how to play through level design

*** Level Design
    
    Designing frames with tilemaps and pre-made scenes (hooking points, etc.)
...
*** Audio
    ...
    Creating a game soundtrack with Free Software /Include the plugins, virtual instruments you found/
    Doing sound design for your game with Free Software
...
*** Combat and AI
    ...
    Player health, taking damage on contact, and stagger state
...
*** Graphics
    ...
    Integrating graphics, animation, and audio into the game
